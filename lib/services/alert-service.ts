  ...
  try {
    ...
    if (dbContacts.length === 0) {
      ...
      if (user && user.emergencyContacts && user.emergencyContacts.length > 0) {
        ...
        We've noticed that ${user.name} might be experiencing some difficult thoughts and emotions. 
        They may need your support at this time. Please reach out to them as soon as possible.

        This is a sensitive situation that requires immediate attention. We recommend:
        1. Contacting ${user.name} directly
        2. Speaking with them in person if possible
        3. Encouraging them to seek professional help if needed

        If you're concerned about their immediate safety, please contact emergency services.

        Thank you for being there for ${user.name}.
        
        Best regards,
        SoulScript Support Team
        `;
